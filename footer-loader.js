        ...
        <footer class="footer">
            <div class="footer-content">
                <div class="footer-section">
                    <h3>Nethni Pabasara</h3>
                    <p>Management Information Systems undergraduate at NSBM Green University, passionate about creating innovative solutions and making a positive impact through technology.</p>
                    <div class="footer-social">
                        <a href="https://github.com/nethnipabasara" class="social-link" target="_blank" title="GitHub">
                            <i class='bx bxl-github'></i>
                        </a>
                        <a href="https://www.linkedin.com/in/nethni-pabasara-mannage-3a64492a1?utm_source=share_via&utm_content=profile&utm_medium=member_ios" class="social-link" target="_blank" title="LinkedIn">
                ...
                <div class="footer-section">
                    ...
                    <ul>
                        <li>
                            <a href="https://www.google.com/maps/search/?api=1&query=Kegalle,+Sri+Lanka" style="color: #ccc; text-decoration: none; display: flex; align-items: center;">
                                <i class='bx bx-map'></i>Kegalle, Sri Lanka
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="tel:+94743096701" style="color: #ccc; text-decoration: none; display: flex; align-items: center;">
                                <i class='bx bx-phone'></i> +94 743096701
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="footer-bottom">
                <p>&copy; 2026 Nethni Pabasara. All Rights Reserved.</p>
